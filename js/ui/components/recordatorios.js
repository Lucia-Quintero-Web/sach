...
/**
 * Genera el mensaje de bienvenida y confirmación de ficha de registro para pacientes nuevos
 * @param {Object} data - { nombre }
 * @returns {string} - Mensaje formateado para WhatsApp
 */
export function generarMensajeBienvenidaPremium({ nombre }) {
    return `✨ *S.A.C.H. - Bienvenida a la Clínica* ✨
